...
Namespace IdentityMigrations
    ...
    Public NotInheritable Partial Class LicenzeEDispositivi
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(LicenzeEDispositivi))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202210060952487_LicenzeEDispositivi"
            End Get
        End Property
