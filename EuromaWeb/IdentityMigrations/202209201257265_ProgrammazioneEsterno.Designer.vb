...
Namespace IdentityMigrations
    ...
    Public NotInheritable Partial Class ProgrammazioneEsterno
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ProgrammazioneEsterno))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209201257265_ProgrammazioneEsterno"
            End Get
        End Property
