...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class DisegniServerMPA
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DisegniServerMPA))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207131426444_DisegniServerMPA"
            End Get
        End Property
