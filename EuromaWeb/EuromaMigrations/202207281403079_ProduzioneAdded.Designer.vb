...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class ProduzioneAdded
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ProduzioneAdded))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207281403079_ProduzioneAdded"
            End Get
        End Property
