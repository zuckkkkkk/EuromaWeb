...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class AddedPriorita
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPriorita))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207291430020_AddedPriorita"
            End Get
        End Property
