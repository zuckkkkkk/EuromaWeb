...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class IsRevisione
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(IsRevisione))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202205161310037_IsRevisione"
            End Get
        End Property
