...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class StoricoGrezzi
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(StoricoGrezzi))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202212131326551_StoricoGrezzi"
            End Get
        End Property
