...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class AccensioneSpegnimento
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AccensioneSpegnimento))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202212061551287_AccensioneSpegnimento"
            End Get
        End Property
