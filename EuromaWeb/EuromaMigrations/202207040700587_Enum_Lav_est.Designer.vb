...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Enum_Lav_est
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Enum_Lav_est))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207040700587_Enum_Lav_est"
            End Get
        End Property
