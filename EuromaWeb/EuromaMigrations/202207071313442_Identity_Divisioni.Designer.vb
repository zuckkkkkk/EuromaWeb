...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Identity_Divisioni
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Identity_Divisioni))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207071313442_Identity_Divisioni"
            End Get
        End Property
