...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class ProduzioneAdded_Db
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ProduzioneAdded_Db))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207281404003_ProduzioneAdded_Db"
            End Get
        End Property
