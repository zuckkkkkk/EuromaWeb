...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class ArticoliErrati
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ArticoliErrati))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202301181043368_ArticoliErrati"
            End Get
        End Property
