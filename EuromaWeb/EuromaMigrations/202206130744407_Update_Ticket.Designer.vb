...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Update_Ticket
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Update_Ticket))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202206130744407_Update_Ticket"
            End Get
        End Property
