...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class BrandPerAccettazione
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(BrandPerAccettazione))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202208251222576_BrandPerAccettazione"
            End Get
        End Property
