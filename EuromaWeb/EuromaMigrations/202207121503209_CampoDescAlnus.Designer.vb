...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class CampoDescAlnus
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CampoDescAlnus))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207121503209_CampoDescAlnus"
            End Get
        End Property
