...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class ProgettiUT1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ProgettiUT1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202205061221475_ProgettiUT1"
            End Get
        End Property
