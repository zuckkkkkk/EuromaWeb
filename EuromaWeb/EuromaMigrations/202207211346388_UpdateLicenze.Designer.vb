...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class UpdateLicenze
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UpdateLicenze))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207211346388_UpdateLicenze"
            End Get
        End Property
