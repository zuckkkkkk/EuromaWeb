...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class DatiMacchina_Agg
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DatiMacchina_Agg))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202210051214526_DatiMacchina_Agg"
            End Get
        End Property
