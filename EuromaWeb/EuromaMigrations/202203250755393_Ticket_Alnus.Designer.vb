...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Ticket_Alnus
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Ticket_Alnus))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202203250755393_Ticket_Alnus"
            End Get
        End Property
