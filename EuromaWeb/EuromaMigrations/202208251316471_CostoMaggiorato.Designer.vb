...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class CostoMaggiorato
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CostoMaggiorato))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202208251316471_CostoMaggiorato"
            End Get
        End Property
