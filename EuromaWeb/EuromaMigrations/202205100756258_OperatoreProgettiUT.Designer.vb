...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class OperatoreProgettiUT
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(OperatoreProgettiUT))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202205100756258_OperatoreProgettiUT"
            End Get
        End Property
