...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Overviewv21
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Overviewv21))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202201281156061_Overviewv21"
            End Get
        End Property
