...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class ComputerUtenti
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ComputerUtenti))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202212051238068_ComputerUtenti"
            End Get
        End Property
