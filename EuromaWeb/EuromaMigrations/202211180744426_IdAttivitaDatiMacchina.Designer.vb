...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class IdAttivitaDatiMacchina
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(IdAttivitaDatiMacchina))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202211180744426_IdAttivitaDatiMacchina"
            End Get
        End Property
