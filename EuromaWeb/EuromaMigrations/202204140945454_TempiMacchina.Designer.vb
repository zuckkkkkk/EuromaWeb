...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class TempiMacchina
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TempiMacchina))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202204140945454_TempiMacchina"
            End Get
        End Property
