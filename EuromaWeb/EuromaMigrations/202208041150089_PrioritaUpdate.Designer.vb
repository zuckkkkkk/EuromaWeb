...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class PrioritaUpdate
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(PrioritaUpdate))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202208041150089_PrioritaUpdate"
            End Get
        End Property
