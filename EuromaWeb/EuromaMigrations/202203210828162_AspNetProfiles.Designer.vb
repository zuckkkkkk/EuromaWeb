...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class AspNetProfiles
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AspNetProfiles))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202203210828162_AspNetProfiles"
            End Get
        End Property
