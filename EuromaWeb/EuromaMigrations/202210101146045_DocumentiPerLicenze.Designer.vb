...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class DocumentiPerLicenze
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DocumentiPerLicenze))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202210101146045_DocumentiPerLicenze"
            End Get
        End Property
