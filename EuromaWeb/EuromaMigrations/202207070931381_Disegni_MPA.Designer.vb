...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Disegni_MPA
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Disegni_MPA))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207070931381_Disegni_MPA"
            End Get
        End Property
