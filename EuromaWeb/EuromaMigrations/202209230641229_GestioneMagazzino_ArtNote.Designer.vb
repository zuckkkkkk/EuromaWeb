...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class GestioneMagazzino_ArtNote
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(GestioneMagazzino_ArtNote))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209230641229_GestioneMagazzino_ArtNote"
            End Get
        End Property
