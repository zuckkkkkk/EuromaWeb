...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class ProgettiUT2
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ProgettiUT2))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202205090838330_ProgettiUT2"
            End Get
        End Property
