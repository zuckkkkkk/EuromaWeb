...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class ChangeLog_Visualizzazione
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ChangeLog_Visualizzazione))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207131134259_ChangeLog_Visualizzazione"
            End Get
        End Property
