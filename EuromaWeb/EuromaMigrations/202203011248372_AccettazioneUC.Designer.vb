...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class AccettazioneUC
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AccettazioneUC))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202203011248372_AccettazioneUC"
            End Get
        End Property
