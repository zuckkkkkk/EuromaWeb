...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Overviewv22
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Overviewv22))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202201281201569_Overviewv22"
            End Get
        End Property
