...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class TempiAttivita
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TempiAttivita))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209090850341_TempiAttivita"
            End Get
        End Property
