...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class GestioneMagazzino_Modifica
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(GestioneMagazzino_Modifica))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209231153144_GestioneMagazzino_Modifica"
            End Get
        End Property
