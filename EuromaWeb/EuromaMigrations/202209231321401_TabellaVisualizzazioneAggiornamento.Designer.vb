...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class TabellaVisualizzazioneAggiornamento
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TabellaVisualizzazioneAggiornamento))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209231321401_TabellaVisualizzazioneAggiornamento"
            End Get
        End Property
