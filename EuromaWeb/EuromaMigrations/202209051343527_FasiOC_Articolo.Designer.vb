...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class FasiOC_Articolo
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FasiOC_Articolo))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209051343527_FasiOC_Articolo"
            End Get
        End Property
