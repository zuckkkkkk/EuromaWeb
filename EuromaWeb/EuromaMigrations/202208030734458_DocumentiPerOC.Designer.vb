...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class DocumentiPerOC
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DocumentiPerOC))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202208030734458_DocumentiPerOC"
            End Get
        End Property
