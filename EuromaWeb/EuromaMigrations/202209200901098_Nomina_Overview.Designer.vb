...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Nomina_Overview
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Nomina_Overview))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209200901098_Nomina_Overview"
            End Get
        End Property
