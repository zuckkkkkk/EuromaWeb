...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class Stato_Accettazione
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Stato_Accettazione))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202204061115300_Stato_Accettazione"
            End Get
        End Property
