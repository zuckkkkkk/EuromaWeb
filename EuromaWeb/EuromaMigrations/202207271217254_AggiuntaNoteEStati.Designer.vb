...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class AggiuntaNoteEStati
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AggiuntaNoteEStati))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202207271217254_AggiuntaNoteEStati"
            End Get
        End Property
