...
Namespace EuromaMigrations
    ...
    Public NotInheritable Partial Class GestioneMagazzino
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(GestioneMagazzino))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202209211429449_GestioneMagazzino"
            End Get
        End Property
