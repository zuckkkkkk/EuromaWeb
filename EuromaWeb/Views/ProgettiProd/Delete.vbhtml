...
<div>
    ...
    <dl class="dl-horizontal">
        ...
        <dt>
            @Html.DisplayNameFor(Function(model) model.OperatoreSmistamentoId)
        </dt>

        <dd>
            @Html.DisplayFor(Function(model) model.OperatoreSmistamentoId)
        </dd>
        ...
        <dt>
            @Html.DisplayNameFor(Function(model) model.OperatoreId)
        </dt>

        <dd>
            @Html.DisplayFor(Function(model) model.OperatoreId)
        </dd>
