...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-md-3">
            <button class="btn btn-primary" id="Search">Scarica dati</button>
        </div>
    </div>
    <div class="row d-none" style="margin-top: 1rem;">
        <h5 id="Ricavi"></h5>
        <h5 id="Anticipi"></h5>
        <div class="col-md-6 barItaliaContainer">
            <canvas id="barItalia" width="800" height="800" style="max-width: 800px; max-height: 800px; "></canvas>

        </div>
        <div class="col-md-6 barEsteroContainer">
            <canvas id="barEstero" width="800" height="800" style="max-width: 800px; max-height: 800px; "></canvas>
        </div>
    </div>
</div>
