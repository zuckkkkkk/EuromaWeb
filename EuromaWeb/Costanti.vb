Public Module Costanti
    ...
    Public Const WebAppVersion As String = "0.9.9b"
    Public Const WebAppVersionDateBuild As Date = #10/20/2022#
    Public Const WebAppVersionDateRelease As Date = #10/20/2022#
