Public Module Costanti
    ...
    Public Const WebAppVersion As String = "0.9.7a"
    Public Const WebAppVersionDateBuild As Date = #10/04/2022#
    Public Const WebAppVersionDateRelease As Date = #10/04/2022#
